...
/* ─────────────────────────────────────────
   Seção CTA Final — estilo editorial
   Full-bleed com foto + texto sobre overlay
───────────────────────────────────────── */

/* SVG: linhas manuscritas decorativas */
...
export default function SectionCTAFinal() {
  ...
  return (
    ...
    >
      ...
      {/* Decoração: linhas manuscritas canto superior direito */}
      <div
        aria-hidden="true"
        style={{
          position: "absolute",
      ...
      >
        <div style={{ maxWidth: "640px" }}>
          ...
          <FadeInSection delay={0.08}>
            ...
            >
              Seu livro começa com uma conversa.
            </h2>
          </FadeInSection>
          ...
          <FadeInSection delay={0.18}>
            ...
            >
              Responda o diagnóstico em 3 minutos. Vou ler antes de você e chegar pronta para falarmos sobre o seu livro especificamente.
            </p>
          </FadeInSection>
